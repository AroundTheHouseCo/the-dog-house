...
| Same-week incentive | **5%** — `{{SAME_WEEK_SAVINGS}}` variable, set in `data/company-settings.json`. No fixed week boundary — deliberately left undefined; rep's judgment, never a stated day/timestamp. |
